...
<body data-ng-app="my-app"  data-ng-controller="Ctrl">
        ...
        <div class="wrapper">
            ...
            <div id="content" class="container">
				...
				<div class="row">
	                <form class="col-md-12" name="absForm" action='<c:url value="/prof/getabsence" />' method="post" enctype="multipart/form-data">
						<div class="col-md-9 col-md-offset-1">
								...
								<div class="form-groupe">
									 <button type="submit" class="btn btn-primary col-md-3" data-ng-disabled="absForm.$invalid" >Modifier</button>
								</div>
						</div>	                  	
	                </form>
				</div> 					
    ...
    <script>
		...
		app.controller("Ctrl", function($scope, $http) {
			...
			$scope.getSeances = function(){	
				...
				var response = $http.post('loadSeancesV1', md);
