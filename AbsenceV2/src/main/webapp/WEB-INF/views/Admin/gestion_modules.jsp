...
<body data-ng-app="my-app"  data-ng-controller="Ctrl">
        ...
        <div class="wrapper">
            ...
            <div id="content" class="container">
                ...
                <form class="row" name="modulesForm" action='<c:url value="/admin/gestion_modules" />' method="post" enctype="multipart/form-data">
					<div class="col-md-9 col-md-offset-1">
								...
								<c:choose>
									<c:when test="${result == 'done' }">
										<div class="alert alert-success alert-dismissible">
										  ...
										  <strong>Success!</strong> Opération bien faite.
										</div>
									</c:when>
									<c:otherwise>
							...
							<div class="form-group">
								<legend>Gestion des Modules</legend>
						    	<label for="file">Fichier (Titre, Semestre, Professeur(Nom prenom))</label>
								<input type="file" name="modules" data-ng-model="modules" class="form-control" data-ng-required="true" />					
								{{modules}}
							</div>
							<div class="form-groupe">
								 <button type="submit" class="btn btn-primary col-md-3">GO</button>
								 <a href='<c:url value="/admin/detail_modules" />' class="col-md-offset-6 col-md-3 btn btn-default" >Detail des modules</a>
							</div>
					</div>	                  	
                </form>
